...
const testimonials = [
  {
    ...
    review: 'S.M Design & Construction exceeded every expectation we had. Their professionalism in managing the timeline and their design taste transformed our apartment. The kitchen is both incredibly gorgeous and highly functional.',
    initials: 'RM',
  },
  {
    id: 2,
    name: 'Anjali Sharma',
    project: 'Luxury Penthouse, Basirhat',
